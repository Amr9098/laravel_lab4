...
<body>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 container justify-content-center mt-5">
        ...
        <form action="{{route("phones.update",$phone->id)}}" method="Post" autocomplete="off" >
            @method("PUT")
            @csrf
            <div class="form-group ">
              <label class="fw-bold">phone</label>
              <input type="text" class="form-control  @error('phone') is-invalid @enderror"  name="phone"  value="{{$phone->phone}}" required>
